...
function Review() {
  return (
    <div className="w-full">
      <div className="bg-red-500 py-16 px-10">
        <h2 className='text-white text-center font-bold pb-10 text-5xl'>People Who Work With Us Say</h2>
          ...
          <div className="bg-white py-10 px-10 w-[500px] rounded-lg hover:-translate-x-1 hover:-translate-y-1 transition cursor-pointer">
            <div>
              ...
              <span className='flex flex-col items-center'>
                ...
                <p className='font-bold py-1'>Founder, Co-Contributor of Bdrive</p>
