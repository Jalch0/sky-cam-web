  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-10 pb-10">
        <div className="shadow-lg flex flex-col items-center rounded-lg sm:px-28 px-14 py-20 hover:translate-y-2 hover:translate-x-2 hover:bg-gray-100 transition cursor-pointer text-center">
          <span className="pb-1">
