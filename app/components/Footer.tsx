...
function Footer() {
  return (
    <div className='pt-14 w-full bg-neutral-200'>
        <div className='flex sm:justify-between flex-col px-10 items-center lg:items-start lg:gap-10 lg:flex-row w-full'>
          {/* Left */}
          <div className='sm:w-96 flex flex-col items-center gap-2'>
            <Image
            src={LogoSkyCam}
            alt='Logo SkyCam'
            width={170}
          ...
          {/* Right */}
          <div className='sm:w-[600px] w-[300px] mb-5'>
            {/* @ts-ignore */}
        ...
        <div className='py-6 text-center w-full bg-neutral-300'>
